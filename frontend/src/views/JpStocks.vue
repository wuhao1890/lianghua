  ...
  <div class="market-hub">
    <div class="page-header">
      <div class="header-left">
        <el-icon :size="22" color="#909399"><TrendCharts /></el-icon>
        <span class="page-title">日股市场</span>
      ...
      <el-tab-pane label="大盘指数" name="indices">
        <div class="indices-section">
          <div class="section-header">
            <span class="section-title">日本主要指数</span>
...
async function loadIndices() {
  ...
  try {
    const res = await getGlobalIndices('JP')
    indices.value = res.data?.data || []
  } catch (e: any) {
    ElMessage.error(e.message || '加载日股指数数据失败')
    indices.value = []
  } finally {
